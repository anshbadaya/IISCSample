# IISC BLR By Themefisher

IISC BLR is a set of landing and support pages aimed at helping companies promote new products and business launches.
...
We use GitHub Issues as the official bug tracker for the IISC BLR Template. Please Search [existing issues](https://github.com/themefisher/IISC BLR-It-Solutions-Corporate-Template/issues). It’s possible someone has already reported the same problem.
If your problem or idea has not been addressed yet, feel free to [open a new issue](https://github.com/themefisher/IISC BLR-It-Solutions-Corporate-Template/issues).
